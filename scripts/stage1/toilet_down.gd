...
var trigger_distance_x: float = 150.0  # trigger when player is this close on the LEFT
var drop_amount: float = 350.0          # pixels to drop (down is +Y)
var drop_speed: float = 2000.0          # pixels/sec
